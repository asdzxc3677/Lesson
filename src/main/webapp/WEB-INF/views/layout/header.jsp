    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <div class="text-end">
                ...
                <c:if test="${sessionScope.loginId == '삼청대장'}">  <%-- 관리자만 보일수 있게 하는 문법이다. --%>
                    <button type="button" class="btn btn-warning" onclick="memberList()">회원신상정보</button>
                </c:if>

                <c:if test="${sessionScope.loginId !=null and sessionScope.loginId !='삼청대장'}">  <%-- 개인회원은 '나의정보' 라는것이 보이지만 관리자는 안보이게 처리하였다. --%>
